...
SAMPLE_QUERIES = [
    "ฮาร์ดแวร์คอมพิวเตอร์ คืออะไร",
    "SSD กับ HDD แตกต่างกันอย่างไร และควรเลือกใช้อะไร",
    "เมนบอร์ด มีความสำคัญอย่างไรในการประกอบคอมพิวเตอร์",
    "การ์ดจอ จำเป็นสำหรับผู้ใช้ทุกคนหรือไม่",
]
