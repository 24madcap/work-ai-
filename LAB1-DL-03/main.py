...
def main():
    ...
    print("-ระบบ RAG สำหรับถามตอบเกี่ยวกับคอมพิวเตอร์ ---")
    print("-พิมพ์ ('exit', 'quit', or 'q' เพื่อออกจากโปรแกรม)---\n")
    ...
    while True:
        ...
        if not results:
            print("ไม่พบคำตอบที่เกี่ยวข้องในฐานข้อมูลความรู้.")
            continue
