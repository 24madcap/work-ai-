# -*- coding: utf-8 -*-
# Problem 09: CHUNK_SIZE / OVERLAP / EVAL_K_VALUES on real data from com_q_a.txt
...
def run():
    ...
    print(f"Real document from com_q_a.txt is {total_chars} characters long ({len(data)} Q&A)")
    ...
    print("Golden Set =", len(data), "(uses every question in com_q_a.txt as the test set)")
