...
# Uses com_q_a.txt as a real Knowledge Base
...
def bad_generate(question, context):
    if not context:
        ...
        return "เกิดอาการจอฟ้าให้ปิดคอมแล้วเปิดใหม่ (ข้อมูลนี้ไม่มีอยู่จริงใน Knowledge Base)"
...
def run():
    ...
    print("e.g. a question that is completely outside the scope of the Knowledge Base (com_q_a.txt)")
