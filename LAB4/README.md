...
This project demonstrates 9 common problems in LLM and RAG (Retrieval-Augmented Generation) systems. All simulations use the same real dataset, com_q_a.txt, which is a Thai computer question-answer knowledge base. This allows each problem to be tested with real data instead of isolated sample data.

# Structure:

```text
RAG-Project/
├── com_q_a.txt                    # Raw data / RAG Knowledge Base
├── data_loader.py                 # Shared parser: com_q_a.txt -> list of dict
...
# Dataset:
The project uses one shared Knowledge Base containing Thai questions and answers about computer, consent, anatomy, and related laws.

The dataset contains 200 entries, covering 10 main categories and 3 language styles: formal, casual, and slang.
